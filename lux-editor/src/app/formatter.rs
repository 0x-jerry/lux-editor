...
impl App {
    ...
    pub(super) fn format_active_document(&mut self, _ctx: &egui::Context) {
    ...
    pub(super) fn on_formatting_finished(
        &mut self,
        generation: u64,
        from_save: bool,
...
pub(super) fn run_formatter(command: &str, args: &str, text: &str) -> Result<String, String> {
