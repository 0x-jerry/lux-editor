...
mod tests {
    ...
    fn language_kind_from_path() {
        ...
        assert_eq!(
            LanguageKind::from_path(Some(Path::new("package.json"))),
            LanguageKind::Json
        );
        assert_eq!(
            LanguageKind::from_path(Some(Path::new("tsconfig.jsonc"))),
            LanguageKind::Json
        );
        assert_eq!(
            LanguageKind::from_path(Some(Path::new("CONFIG.YML"))),
            LanguageKind::Yaml
        );
        assert_eq!(
            LanguageKind::from_path(Some(Path::new("Cargo.toml"))),
            LanguageKind::Toml
        );
        assert_eq!(
            LanguageKind::from_path(Some(Path::new("deploy.sh"))),
            LanguageKind::Shell
        );
        assert_eq!(
            LanguageKind::from_path(Some(Path::new("app.py"))),
            LanguageKind::Python
        );
        assert_eq!(
            LanguageKind::from_path(Some(Path::new("feed.xml"))),
            LanguageKind::Xml
        );
        assert_eq!(
            LanguageKind::from_path(Some(Path::new("logo.svg"))),
            LanguageKind::Xml
        );
        assert_eq!(
